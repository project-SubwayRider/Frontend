...
import 'package:deliveryapp/data/chat.dart'; // ChatItem 가져오기
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/chats': (context) {
          final chat = ModalRoute.of(context)!.settings.arguments as ChatItem;
          return ChatScreen(item: chat); // ← 필수 파라미터 전달
        },
      },
    );
  }
